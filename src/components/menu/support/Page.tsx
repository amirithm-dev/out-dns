...
export default function Support({section}: {section: string}){
    ...
    return(
        <div className={(section == "support" ? "" : "translate-x-full opacity-0 ") + "absolute top-0 left-0 duration-300 w-full h-full flex justify-between items-center flex-col p-5 gap-2"}>
            <div className="w-11/12 p-1.5 bg-zinc-900 rounded-sm drop-shadow-2xl border border-black flex flex-col gap-2">
            ...
            <div className="w-full bg-zinc-900 p-1 rounded-md flex justify-around items-center text-[0.85rem] relative group overflow-hidden border border-black">
            ...
            <div className="flex gap-4 w-full items-center justify-center text-[0.9rem]">
                <div onClick={async ()=>{writeToClipboard(walletAddress)}} className="bg-zinc-900 rounded-md w-fit p-2 items-center border border-black drop-shadow-2xl flex gap-4 duration-300 ease-in-out hover:-translate-y-0.5 cursor-pointer">
                ...
                <div onClick={async ()=>{await openUrl("https://reymit.ir/amirithm")}} className="bg-zinc-900 rounded-md w-fit p-2 items-center border border-black drop-shadow-2xl flex gap-4 duration-300 ease-in-out hover:-translate-y-1 cursor-pointer">
