...
export default function DNSServersList(){
    ...
    return(
        <div ref={comboRef} className="w-60 h-10 flex justify-end absolute top-10 right-12 z-20 select-none">
                    ...
                    </div>
                    {
                        DNSList.map((dns,k)=>{
                            ...
                            <div key={k} className="flex gap-2">
                                <div className="w-px min-w-px h-full bg-[#005eff8a] rounded-full"></div>
